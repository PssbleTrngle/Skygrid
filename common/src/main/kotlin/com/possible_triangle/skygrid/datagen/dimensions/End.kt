        ...
        gridConfig(LevelStem.END) {
            ...
            blocks {
                list("ground") {
                    block(Blocks.END_STONE) {
                        side(UP, probability = 0.1) {
                            block("chorus_weeds", QUARK)
                            block("chorus_twist", QUARK)
                        }
                    }
                    ...
                    block("poismoss", ENDERGETIC, weight = 0.5) {
                        side(UP, probability = 0.8) {
                            block("poise_bush", ENDERGETIC)
                            block("tall_poise_bush", ENDERGETIC, weight = 0.5) {
                                property(DOUBLE_BLOCK_HALF, DoubleBlockHalf.LOWER)
                                side(UP) {
                                    block("tall_poise_bush", ENDERGETIC) {
                ...
                list("wood", weight = 0.1) {
                    block("poise_planks", ENDERGETIC, weight = 0.2)
                    block("poise_stem", ENDERGETIC)
                    block("poise_cluster", ENDERGETIC)
                    block("glowing_poise_stem", ENDERGETIC)
                }
                ...
                list("building") {
                    ...
                    list("obsidian", weight = 0.1) {
                        ...
                        side(DOWN, probability = 0.5) {
                            block("acidian_lantern", ENDERGETIC) {
                    ...
                    list("endstone bricks") {
                        ...
                        block("cracked_end_stone_bricks", ENDERGETIC, weight = 0.5)
                        block("chiseled_end_stone_bricks", ENDERGETIC, weight = 0.5)
                    }

                    list("purpur") {
                        block(Blocks.PURPUR_PILLAR)
                        block(Blocks.PURPUR_BLOCK)
                        block("cracked_purpur_block", ENDERGETIC, weight = 0.5)
                    }

                    list("duskbound", weight = 0.5) {
                        block("duskbound_block", QUARK)
                        block("duskbound_lantern", QUARK)
                    }

                    list("myalite") {
                        block("myalite", QUARK, weight = 10.0)
                        block("myalite_crystal", QUARK, weight = 5.0)
                        block("dusky_myalite", QUARK)
                        block("myalite_bricks", QUARK)
                        block("chiseled_myalite_bricks", QUARK)
                        block("myalite_pillar", QUARK)
                    }

                    block(Blocks.ENDER_CHEST, weight = 0.01)
                    block("poise_bookshelf", ENDERGETIC, weight = 0.01)
                }

                list("compressed", weight = 0.05) {
                    block("chorus_fruit_block", QUARK)
                    block("bolloom_crate", ENDERGETIC)
                    block("boof_block", ENDERGETIC, weight = 0.1)
                }
                ...
                list("loot", weight = 0.01) {
                    ...
                    fallback {
                        ...
                        list {
                            block("purpur_chest", QUARK)
                            block("poise_chest", ENDERGETIC)
                        }
                        block(Blocks.CHEST)
                    }
                }
