...
public class DefaultsHunting extends Defaults {
    ...
    public static RandomCollection<BlockInfo> leaves() {
        return new RandomCollectionJson<>(BlockInfo.class)
                .add(4, new BlockInfo().add(Blocks.LEAVES.getDefaultState().withProperty(BlockOldLeaf.VARIANT, BlockPlanks.EnumType.OAK)));
    }

    public static RandomCollection<BlockInfo> logs() {
        return new RandomCollectionJson<>(BlockInfo.class)
                .add(4, new BlockInfo().add(Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK)));
    }
    ...
    public static RandomCollection<BlockInfo> dirt() {
        return new RandomCollectionJson<>(BlockInfo.class)
                .add(3, new BlockInfo().add(Blocks.SAND.getDefaultState().withProperty(BlockSand.VARIANT, BlockSand.EnumType.SAND)))
                .add(2, new BlockInfo().add(Blocks.SAND.getDefaultState().withProperty(BlockSand.VARIANT, BlockSand.EnumType.SAND))
                        .addAt(EnumFacing.UP, Blocks.REEDS))
