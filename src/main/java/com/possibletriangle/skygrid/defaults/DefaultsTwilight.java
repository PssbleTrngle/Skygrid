...
public class DefaultsTwilight extends Defaults {
    ...
    public void registerBlocks(RandomCollection<BlockInfo> blocks, int floor) {
        ...
        RandomCollection<BlockInfo> misc = new RandomCollection<BlockInfo>()
        ...
        RandomCollection<BlockInfo> building = new RandomCollection<BlockInfo>()
                .add(0.2, new RandomCollection<BlockInfo>()
                ...
                .add(1, new RandomCollection<BlockInfo>()
                ...
                .add( 0.1, new RandomCollection<BlockInfo>()
