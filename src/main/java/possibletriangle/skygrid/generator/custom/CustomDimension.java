...
public class CustomDimension extends OverworldDimension {
    ...
    public boolean isDaytime() {
        CreateOptions.Daytime daytime = getOptions().map(c -> c.daytime).orElse(CreateOptions.Daytime.UNSET);
        switch (daytime) {
            case DAY:
                return true;
            case NIGHT:
    ...
    public ChunkGenerator<?> createChunkGenerator() {
        DimensionLoader.findConfig(world.getDimension().getType(), this::reloadConfig);
