        ...
        dimension(ResourceLocation("overworld")) {
            ...
            blocks {
                ...
                list("ground", weight = 100.0) {
                    ...
                    list("dirt", weight = 20.0) {
                        block(Blocks.DIRT)
                        block(BOPBlocks.MUD, weight = 0.1)
                    ...
                    list("cold") {
                        ...
                        block(PermafrostModule.permafrost, weight = 0.05)
                    }
                }
                ...
                list("tree", weight = 50.0) {
                    ...
                    list("mushrooms blocks") {
                        ...
                        block(GlimmeringWealdModule.glow_shroom_block, weight = 0.1)
                        block(BOPBlocks.GLOWSHROOM_BLOCK, weight = 0.1)
                    }
                }
                ...
                list("building", weight = 14.0) {
                    list("bricks") {
                        ...
                        list("bricks") {
                            ...
                            list("quark bricks") {
                                listOf(jasperBlock, limestoneBlock, shaleBlock).forEach { type ->
                                    polishedBlocks[type]?.let { block(it, weight = 0.5) }
                                }
                            }
                        }
                    }
                ...
                list("compressed", weight = 6.0) {
                    ...
                    list {
                        ...
                        block(CompressedBlocksModule.stick_block)
                    ...
                    list("plants") {
                        ...
                        block(CompressedBlocksModule.bamboo_bundle, weight = 0.1)
