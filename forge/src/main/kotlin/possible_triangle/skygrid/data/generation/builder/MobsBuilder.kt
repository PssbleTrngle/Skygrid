...
import net.minecraftforge.registries.ForgeRegistries.ENTITY_TYPES
...
class MobsBuilder {
    ...
    fun mob(type: EntityType<*>, weight: Double = 1.0) = mob(requireNotNull(ENTITY_TYPES.getKey(type)), weight)
