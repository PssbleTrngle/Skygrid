package possible_triangle.skygrid.forge.datagen.dimensions
...
import possible_triangle.skygrid.forge.datagen.DimensionConfigGenerator
                ...
                list("building", weight = 20.0) {
                    list("bricks") {
                        ...
                        list("bricks") {
                            ...
                            block(Blocks.MUD_BRICKS, weight = 0.1)
                            list("stone bricks") {
